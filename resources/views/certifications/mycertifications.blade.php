        ...
        <div class="card border border-primary">
            ...
            <div class="card-body">
                ...
                @foreach ($certifications as $certification)
                    <!-- Certification Name -->
                    <h5 class="my-0 text-primary"><i class="uil uil-award"></i> {{ $certification->name ?? '' }}</b>
                    </h5>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="{{ url('/resources/' . $discipline->id . '/docs') }}"
                                            ...
                                            <i class="uil uil uil-file-plus font-size-24"></i>
                                        </a>
                                    </td>
                                    <td class="text-center align-middle">
                                        <a href="{{ url('/resources/' . $discipline->id . '/tasks') }}"
                                            class="px-3 text-primary">
                                            <i class="uil uil-apps font-size-24"></i>
                                        </a>
                                    </td>
                                    <td class="text-center align-middle">
                                        <a href="{{ url('/resources/' . $discipline->id . '/test') }}"
                                            class="px-3 text-primary">
                                            <i class="uil uil-pen font-size-24"></i>
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
